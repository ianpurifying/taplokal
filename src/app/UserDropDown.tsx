...
const UserDropdown = ({ onClose, onUploadComplete }: UserDropdownProps) => {
  ...
  return (
    <div className="absolute right-0 lg:top-10 top-16 w-64 lg:w-full bg-white border rounded-lg shadow-lg z-20">
      ...
      {/* Recent notification */}
      <div>
        <h3 className="text-sm font-semibold p-2 text-black/30">
          Recent Notification
        </h3>
      ...
      >
        ...
        <div className="w-full text-left p-2">About</div>
      </Link>
      <Link
        href={"/#categories"}
        onClick={onClose}
      ...
      >
        ...
        <div className="w-full text-left p-2">Menu</div>
      </Link>
      <Link
        href={"/order-history"}
        onClick={onClose}
      ...
      >
        ...
        <div className="w-full text-left p-2">Order History</div>
      </Link>
      <Link
        href={"/#"}
      ...
      >
        ...
        <div className="w-full text-left p-2">Logout</div>
      </Link>
    </div>
  );
};
