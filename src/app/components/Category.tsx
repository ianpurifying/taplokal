...
const Categoryitem = [
  ...
  },
  {
    ...
    svg: (
      ...
      >
        <path
          d="M18.4998 3.00194L15.0604 6.44128C14.4746 7.02707 14.4746 7.97681 15.0604 8.5626L15.7498 9.25194M21.9998 6.50194L18.5604 9.94128C17.9746 10.5271 17.0249 10.5271 16.4391 9.94128L15.7498 9.25194M15.7498 9.25194L3.99976 21.0019"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M7.98914 8.99011C6.79472 10.1845 5.15674 10.4831 3.66377 8.99011C2.17075 7.49708 1.38801 4.77782 2.58243 3.5834C3.77685 2.38898 6.49611 3.17172 7.98914 4.66474C9.48211 6.15772 9.18356 7.79569 7.98914 8.99011ZM7.98914 8.99011L20 21.001"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
        <path
          d="M9.20542 2.39668C10.0923 2.13907 11.03 2.00097 12 2.00097C13.1517 2.00097 14.2579 2.19566 15.2876 2.55393M2.04937 11.001C2.01672 11.3299 2 11.6635 2 12.001C2 14.0328 2.60598 15.9231 3.64707 17.501M7.77267 21.0661C9.05671 21.6659 10.4892 22.001 12 22.001C13.5244 22.001 14.9691 21.6599 16.262 21.0499M20.3529 17.501C21.394 15.9231 22 14.0328 22 12.001C22 11.4228 21.9509 10.8561 21.8567 10.3048"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    svg: (
      ...
      >
        <path
          d="M20.435,24.364c-1.781,1.512-3.389,4.2-3.459,8.168c-0.007,0.378-0.267,0.696-0.634,0.772c-1.976,0.418-4.835,0.313-6.317-1.168
        ...
        />
        <path
          d="M43.565,24.364c1.781,1.512,3.389,4.2,3.459,8.168c0.007,0.378,0.267,0.696,0.634,0.772c1.976,0.418,4.835,0.313,6.317-1.168
    ...
    <>
      {Categoryitem.map((item, index) => (
        <Link
          href={item.href}
          key={index}
          className="bg-white hover:bg-foreground/20 shadow-lg text-foreground border items-center justify-center flex flex-col p-3 lg:p-5 rounded-xl"
        >
          {item.svg}
          <h1 className="text-black/60 mt-5 text-center text-base lg:text-2xl font-semibold whitespace-nowrap">
            {item.name}
          </h1>
        </Link>
      ))}
